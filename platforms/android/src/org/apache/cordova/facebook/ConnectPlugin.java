...
public class ConnectPlugin extends CordovaPlugin {
    ...
    private CallbackContext publishFeedContext = null;
    ...
    private boolean logout(JSONArray args, CallbackContext callbackContext) throws JSONException
    {
        Session session = Session.getActiveSession();
        if (session != null) {
            if (session.isOpened()) {
...
*/
    ...
    private boolean graphApi(JSONArray args, CallbackContext callbackContext) throws JSONException
    {
    ...
    private boolean publishFeed(JSONArray args, CallbackContext callbackContext) throws JSONException
    {
        ...
        publishFeedContext = callbackContext;
        PluginResult pr = new PluginResult(PluginResult.Status.NO_RESULT);
        pr.setKeepCallback(true);
        publishFeedContext.sendPluginResult(pr);
        ...
        while (iter.hasNext()) {
            ...
            try
            {
                ...
                Log.w(TAG, "Nonstring parameter provided to publish feed discarded");
            }
        }
        ...
        final Session session = Session.getActiveSession();
        Request feedRequest = new Request(session, "me/feed", collect, HttpMethod.POST, feedCallback);
	...
	public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
		...
		if (action.equals("login")) {
			...
			return showDialog(args, callbackContext);
